...
task fetch_api_calls: :environment do
  ...
  list_of_companies = %w[BXMT MAIN INTC BRMK HD AAPL UGI MO MMM O IRM ARR GROW GAIN LAND CAT ADP MPLX CC LADR JPM APD PEP PPL WM XOM NEE SJT PVL CRT ORC PII FMS GS ABT TMO ORCL UNP LLY AXP AJX AB WMC RC NLY FSK NYMT VALE SBLK ZIM CVX WBA LEG PM VZ UVV KMI EPD ABR ARE EQR QCOM CSCO T DVN IBM ENB BX SJM DUK MDT TXN TSCO LOW AVGO SMG CURO EPM SPG WMB]
  # list_of_companies = %w[]
